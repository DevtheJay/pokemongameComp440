...
<body>
    <div class="form-container">
        ...
        <form action="" method="post">
            ...
            <div class="form-group">
                <label for="name">First attack:</label>
                <input type="text" id="first" name="first" required>
            </div>
            <div class="form-group">
                <label for="gender">Second attack:</label>
                <input type="text" id="secondary" name="secondary" required>
            </div>
            <div class="form-group">
                <label for="location_id">Third attach:</label>
                <input type="text" id="third" name="third" required>
            </div>
            <div class="form-group">
                <label for="location_id">Forth attach:</label>
                <input type="text" id="forth" name="forth" required>
            </div>
